...
const about = () => {
  ...
  return (
    <div id="AboutPage" className="pt-5">
      <Head>
        <title>Autoconsumo Solar | Instalación de placas solares | Energía Solar</title>
        ...
        <div className="container p-4">
          <div className="row justify-content-center text-center">
            <div className="col-md-10 col-lg-12">
              <h1 className="display-5"><b>POLÍTICA DE PRIVACIDAD - AUTOCONSUMO SOLAR | PV SYSTEM</b></h1>
            </div>
          </div>
        </div>
      </div>
      <section>
        <div className="container py-5 c-gray-2">
          ...
          informa a los usuarios de la app 'Autoconsumo Solar | PV System' (en adelante, la App), acerca del tratamiento de los datos personales, que ellos voluntariamente hayan facilitado durante el
