...
const about = () => {
  ...
  return (
    <div id="AboutPage" className="pt-5">
      <Head>
        <title>Solar Panel Optimal Tilt | Instalación de placas solares | Energía Solar</title>
        ...
        <div className="container p-4">
          <div className="row justify-content-center text-center">
            <div className="col-md-10 col-lg-12">
              <h1 className="display-5"><b>POLÍTICA DE PRIVACIDAD - SOLAR PANEL OPTIMAL TILT</b></h1>
            </div>
          </div>
        </div>
      </div>
      <section>
        <div className="container py-5 c-gray-2">
          ...
          de datos personales y a la libre circulación de estos datos (Reglamento General de Protección de Datos - RGPD), Aikideveloper,
          informa a los usuarios de la app 'Solar Panels Optimal Tilt' (en adelante, la App), acerca del tratamiento de los datos personales, que ellos voluntariamente hayan facilitado durante el
          ...
          Aikideveloper (en adelante, el Responsable del Tratamiento), es la entidad responsable del tratamiento de los datos facilitados
          por los clientes de la App (en adelante, el/los Usuario/s)


          <br></br><br></br><b className="c-dark-1">2. FINALIDAD DEL TRATAMIENTO DE DATOS</b><br></br><br></br>


          Para proceder al registro, acceso, servicios de asesoramiento y posterior uso de la App, el Usuario deberá facilitar
          ...
          a cabo por el Responsable, con la finalidad de garantizar el correcto funcionamiento de la App, mantener la relación
          ...
          App, siempre y cuando, el Usuario haya prestado previamente su consentimiento expreso para la recepción de
          estas comunicaciones vía electrónica o teléfonica.

          La App utiliza servicios de terceros que pueden recopilar información utilizada
          para identificarlo.

          Enlace a la política de privacidad de los proveedores de servicios externos utilizados por la App
          ...
          y/o la contratación de los servicios de la App, cuyos términos y condiciones se pondrán a disposición del Usuario en todo caso, con
          ...
          sus datos, o lo haga de forma errónea o incompleta, no será posible proceder al uso de la App.
          ...
          en los sistemas y bases de datos del Responsable del Tratamiento, mientras aquél continúe haciendo uso de la App,
          ...
          o prestados a través de la App, excepto los servicios específicos de backup, no incluyen la reposición de los contenidos conservados
          ...
          Fecha última actualización: 07/01/2023
          ...
          app (en adelante, la App), titularidad de Aikideveloper (en adelante, el Propietario).

          El registro y posterior uso de la App, requiere la aceptación previa por parte del usuario,
          ...
          El uso de la App, atribuye la condición de usuario de la misma (en adelante, el Usuario) e implica la lectura, entendimiento y aceptación de todos los términos
          ...
          a los cambios efectuados en las condiciones de uso, y si aquél continúa utilizando la App, se entenderá que ello implica la
          ...
          al uso de la App. Si no aceptas los términos incluidos en las mismas, no debes registrarte, acceder, ni utilizar la App.
          ...
          o disponer de autorización expresa de sus padres y/o tutores legales, para poder registrarse, acceder y utilizar la presente App.
          ...
          que le habilitaría para el uso de la App, o bien para que demuestre disponer de autorización de sus padres y/o tutores legales.
          ...
          terceros licenciantes, retendrán en todo momento los derechos de propiedad intelectual sobre la App, así como sobre los diferentes
          ...
          derechos de propiedad intelectual y de explotación sobre el software empleado para el desarrollo y funcionamiento de la App,
          y estará habilitado para descargar e instalar nuevas versiones del software de la App, actualizaciones y mejoras, con el fin
          ...
          excepción de los derechos y licencias necesarios para la utilización y correcto funcionamiento de la App. Además de lo anterior,
          el Propietario es responsable de la selección, diseño de la estructura y disposición de los contenidos de la App, así como quien
          ...
          El Propietario es también el único titular del diseño e imagen gráfica de la App,
          ...
          Respecto a los posibles contenidos generados por el usuario, durante el uso de la App,
          ...
          difunda o publique contenidos en la App, está concediendo una licencia no exclusiva, transferible y gratuita, para poder almacenar,
          reproducir, distribuir, modificar, mantener o comunicar públicamente (difundir, publicar) el contenido generado por el Usuario.


          En el supuesto de que el Usuario, comparta o publique contenidos en la App, que no haya creado o generado él mismo, será el único
          ...
          En cualquier caso, el Propietario informa al Usuario de que, aunque el contenido pueda ser eliminado de la interfaz de la App,
          ...
          descargar o guardar dicho contenido, excediendo estas actuaciones del ámbito o entorno de la App.


          <br></br><br></br><b className="c-dark-1">5. OBLIGACIONES DEL USUARIO</b><br></br><br></br>


          El Usuario se compromete a utilizar la presentApp y todo su contenido de conformidad con la ley, la moral, el orden público y
          las presentes condiciones de uso. Asimismo, se compromete a hacer un uso adecuado de los servicios y/o contenidos de la App.


          En particular, el Usuario se compromete a:

          • No emplear la App para realizar actividades ilícitas o constitutivas de delito,
          ...
          través de la App, que sean contrarios a la ley, la moral, el orden público y las presentes condiciones de uso.

          • No generar,
          compartir o subir contenidos a la App, si son ilegales, engañosos, o discriminatorios, o si vulneran los derechos de otra persona.


          • La publicación o transmisión de cualquier contenido que resulte violento, obsceno, abusivo, racial, xenófobo o difamatorio.


          • No introducir o subir virus o códigos maliciosos, o realizar actividades susceptibles de alterar el correcto funcionamiento de la App.
          ...
          facultará al Propietario, para dar de baja de la App al usuario de manera inmediata, así como para eliminar contenidos generados
          ...
          El Propietario no garantiza que, durante el uso de la App, no puedan producirse
          ...
          efectuar, sin previo aviso, las modificaciones que considere oportunas para el correcto funcionamiento de la App, pudiendo cambiar,
          ...
          en la presente App, si bien, en cualquier caso, el acceso y utilización de la misma es responsabilidad exclusiva del Usuario.
          ...
          cualquier utilización indebida de la App o de sus contenidos así como las infracciones de los derechos que le correspondan a
